package com.example.luodacheng.myapplication;
...
import com.example.luodacheng.myapplication.base.BaseActivity;
...
public class MainActivity extends BaseActivity implements View.OnClickListener{
    @Bind(R.id.button_xs)
    Button button_xs;
    @Bind(R.id.button_big)
    Button button_big;
    @Bind(R.id.button_changzhu)
    Button button_changzhu;
    @Bind(R.id.button_zhidingactivity)
    Button button_zhidingactivity;
    @Bind(R.id.button_open)
    Button button_open;
    @Bind(R.id.button_clearzhiding)
    Button button_clearzhiding;
    @Bind(R.id.button_call)
    Button button_call;
    @Bind(R.id.button_zidingyi)
    Button button_zidingyi;
    @Bind(R.id.button_jindutiao)
    Button button_jindutiao;
    /** 点击跳转到指定的界面 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_xs.setOnClickListener(this);
        button_big.setOnClickListener(this);
        button_changzhu.setOnClickListener(this);
        button_zhidingactivity.setOnClickListener(this);
        button_open.setOnClickListener(this);
        button_clearzhiding.setOnClickListener(this);
        button_call.setOnClickListener(this);
        button_zidingyi.setOnClickListener(this);
        button_jindutiao.setOnClickListener(this);
        initNotify();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.button_big:
                showBigStyleNotify();
                break;
            case R.id.button_changzhu:
                showCzNotify();
                break;
            case R.id.button_zhidingactivity:
                showIntentActivityNotify();
                break;
            case R.id.button_open:
                showIntentApkNotify();
                break;
            case R.id.button_clearzhiding:
            ...
            case R.id.button_zidingyi:
                startActivity(new Intent(this,ZidingyiActivity.class));
                break;
            case R.id.button_jindutiao:
                startActivity(new Intent(this,JindutiaoActivity.class));
                break;
        }
    }
    /** 初始化通知栏 */
...
//		notification.flags = Notification.FLAG_AUTO_CANCEL; //在通知栏上点击此通知后自动清除此通知
        ...
        Intent resultIntent = new Intent(this, JindutiaoActivity.class);
