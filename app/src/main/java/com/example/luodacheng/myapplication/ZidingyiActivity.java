...
import com.example.luodacheng.myapplication.utils.BaseTools;

import butterknife.Bind;
import butterknife.ButterKnife;

public class ZidingyiActivity extends BaseActivity implements View.OnClickListener{
    @Bind(R.id.btn_zidingyi)
    Button btn_zidingyi;
    @Bind(R.id.btn_anniu_zidingyi)
    Button btn_anniu_zidingyi;
    /** Notification 的ID */
    int notifyId = 101;
    ...
    private String TAG = "ZidingyiActivity";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_anniu_zidingyi.setOnClickListener(this);
        initButtonReceiver();
    }
